...
func (l *ListInfo) ToGFWList() []byte {
	...
	gfwlistBytes = append(gfwlistBytes, []byte("! HomePage: https://github.com/jaguarocean/domain-list-custom\n")...)
	gfwlistBytes = append(gfwlistBytes, []byte("! GitHub URL: https://raw.githubusercontent.com/jaguarocean/domain-list-custom/release/gfwlist.txt\n")...)
	gfwlistBytes = append(gfwlistBytes, []byte("! jsdelivr URL: https://cdn.jsdelivr.net/gh/jaguarocean/domain-list-custom@release/gfwlist.txt\n")...)
